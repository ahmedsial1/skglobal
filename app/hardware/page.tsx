      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
                <div className="p-3 bg-sial-slate-dark rounded border border-white/5">
            ...
            <div className="lg:col-span-4 space-y-4 bg-sial-slate-light/50 p-6 rounded-lg border border-white/5">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center pt-8">
          <div className="lg:col-span-5 flex justify-center">
            ...
            <div className="slate-gradient p-8 rounded-xl border border-white/5 w-full max-w-md space-y-6 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-sial-gold/5 rounded-full blur-2xl"></div>
