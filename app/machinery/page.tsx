...
export default function Machinery() {
  ...
  return (
    <div className="bg-white text-slate-900 min-h-screen py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="absolute top-[55%] right-[-15%] w-[35rem] h-[35rem] rounded-full bg-sial-gold/15 blur-[120px] z-0 animate-blob-2 pointer-events-none"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 space-y-16">
        ...
        <ScrollReveal delay={0.15}>
            <section className="bg-parallax-section border border-slate-800 p-8 md:p-12 rounded-2xl relative overflow-hidden shadow-xl" style={{ backgroundImage: "url('/oman_cranes.png')" }}>
              {/* Dark overlay mask */}
              <div className="absolute inset-0 bg-gradient-to-r from-slate-950/98 via-slate-950/90 to-slate-950/75 z-0"></div>
              <div className="space-y-12 relative z-10">
                  ...
                  <div className="lg:col-span-7 space-y-6 text-left">
                    <div className="flex items-center justify-between flex-wrap gap-4">
                      <div className="flex items-center space-x-2">
                        <span className="px-2.5 py-1 rounded bg-blue-500/20 border border-sial-blue/30 text-xs font-bold text-blue-300 animate-pulse-slow">
                          {t("machinery.omanBadge")}
                        </span>
                        <span className="text-xs text-slate-300 font-semibold">SK Transports Oman</span>
                      </div>
                      {/* Logo */}
                      <div className="bg-white/95 px-3 py-1 rounded border border-slate-700/50 flex items-center justify-center max-w-[140px] shadow-sm">
                    ...
                    <div className="flex flex-wrap gap-3 text-[11px] font-semibold text-slate-300">
                      <span className="px-3 py-1 bg-slate-900/60 backdrop-blur-xs rounded-full border border-slate-800">
                    ...
                    <div className="pt-2">
                      <a
                        ...
                        className="btn-shine inline-block px-8 py-4 bg-sial-blue hover:bg-sial-blue-dark text-white font-extrabold uppercase tracking-widest text-sm rounded-md shadow-lg shadow-blue-500/10 transition duration-300 transform hover:-translate-y-1"
                      >
                        {t("machinery.omanCta")}
                      </a>
                    </div>
                ...
                <div className="border-t border-slate-800/80 pt-8 space-y-6">
                  <div className="flex items-center justify-between">
                    <h3 className="text-xs uppercase tracking-widest font-extrabold text-blue-400">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    <HoverCard className="p-4 bg-slate-900/40 backdrop-blur-md rounded-xl border border-slate-800 space-y-3 shadow-sm">
                      <div className="relative w-full aspect-[4/3] rounded-lg overflow-hidden border border-slate-800">
                        <Image
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-400 mt-0.5">350T Lift Capacity Mobile Crane</p>
                      </div>
                    </HoverCard>
                    ...
                    <HoverCard className="p-4 bg-slate-900/40 backdrop-blur-md rounded-xl border border-slate-800 space-y-3 shadow-sm">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-400 mt-0.5">220T Lift Capacity Mobile Crane</p>
                      </div>
                    </HoverCard>
                    ...
                    <HoverCard className="p-4 bg-slate-900/40 backdrop-blur-md rounded-xl border border-slate-800 space-y-3 shadow-sm">
                      <div className="relative w-full aspect-[4/3] rounded-lg overflow-hidden border border-slate-800">
                       ...
                       <div>
                         ...
                         <p className="text-xs text-slate-400 mt-0.5">160T Lift Capacity Mobile Crane</p>
                       </div>
                     </HoverCard>
                   </div>
                 </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <HoverCard className="glass-card p-8 rounded-xl space-y-6 flex flex-col justify-between shadow-sm">
