    ...
    <div className="bg-sial-slate-dark text-white min-h-screen py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-4 flex justify-end">
              <a
                ...
                className="w-full text-center inline-block px-6 py-4 bg-sial-gold hover:bg-sial-gold-dark text-sial-slate-dark font-extrabold uppercase tracking-wider text-sm rounded-md shadow-lg transition duration-300 transform hover:-translate-y-1 gold-glow"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="slate-gradient p-8 rounded-xl border border-white/5 space-y-6 flex flex-col justify-between hover:border-sial-gold/20 transition duration-300">
